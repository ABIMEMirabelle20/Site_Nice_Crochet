...
export default function App() {
  ...
  const updateCartItem = (id, patch) => setCart((prev) => prev.map((it) => (it.id === id ? { ...it, ...patch } : it)));
  ...
  return (
    <>
      ...
      {page === 'collection' && <Collection goTo={goTo} showToast={showToast} addToCart={addToCart} cartCount={cart.length} />}
      {page === 'commander' && <Commander goTo={goTo} showToast={showToast} cart={cart} updateCartItem={updateCartItem} removeFromCart={removeFromCart} />}
