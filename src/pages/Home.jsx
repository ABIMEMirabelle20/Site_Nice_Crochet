      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-eyebrow">
            Artisanat béninois · Édition limitée
          </div>
          ...
          <p className="hero-desc">
            Un univers de passion, d'élégance et de savoir-faire.
            Nos pièces sont <strong>100% faites main</strong>,
      ...
      <div className="why-strip">
        ...
        <div className="why-grid">
          ...
          <div className="why-card reveal">
            ...
            <p>
              Chaque pièce est conçue avec patience et précision
              pour une finition impeccable qui vous distingue.
            </p>
          ...
          <div className="why-card reveal">
            ...
            <p>
              Matières sélectionnées et production raisonnée
              pour des vêtements qui durent dans le temps.
            </p>
          ...
          <div className="why-card reveal">
            ...
            <p>
              Choix, prise de mesures, acompte et livraison sécurisée.
              Vous êtes suivi à chaque étape.
            </p>
        ...
        <div className="products-grid">
          ...
          <div className="product-card reveal">
            ...
            <div className="product-info">
              ...
              <p>
                Élégance naturelle et légèreté pour toutes occasions
              </p>
          ...
          <div className="product-card reveal">
            ...
            <div className="product-img-wrap">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg,var(--terracotta),var(--chocolate-light))'
                }}
              >
              </div>
          ...
          <div className="product-card reveal">
            ...
            <div className="product-img-wrap">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg,var(--chocolate-light),var(--chocolate))'
                }}
              >
                🎀
              </div>
        ...
        <div className="process-inner">
          ...
          <div className="steps-grid">
            ...
            <div className="step reveal">
              ...
              <p>
                Un modèle existant ou une pièce entièrement
            ...
            <div className="step reveal">
              ...
              <p>
                Nous récupérons vos mensurations en ligne
                ou en présentiel pour un ajustement parfait.
              </p>
            ...
            <div className="step reveal">
              ...
              <p>
                Confection artisanale avec soin,
                précision et raffinement. Chaque point compte.
              </p>
            ...
            <div className="step reveal">
              ...
              <p>
                Remise en main propre ou livraison sécurisée
                avec suivi complet.
              </p>
