    ...
    <div className="page active" id="page-apropos">
      <div className="about-hero">
        <div className="about-hero-content">
          ...
          <h1>À propos de<br /><em>Nice Création</em></h1>
        </div>
      </div>
      ...
      <div className="about-body">
        ...
        <div className="about-text reveal-right">
          ...
          <p><strong>Nice Création</strong> est une marque béninoise née d'une ambition : celle de devenir indépendante et d'apprendre un métier issu du savoir-faire. Et quoi de mieux que les habits tricotés pour incarner cet idéal ?</p>
          ...
          <div className="timeline">
            <div className="tl-item"><div className="tl-dot">1</div><div className="tl-content"><strong>Les débuts</strong><p>Premiers points, premières créations — une passion qui prend forme.</p></div></div>
            <div className="tl-item"><div className="tl-dot">2</div><div className="tl-content"><strong>Premières clientes</strong><p>Le bouche-à-oreille fait son œuvre. La qualité parle d'elle-même.</p></div></div>
            <div className="tl-item"><div className="tl-dot">3</div><div className="tl-content"><strong>Nice Crochet aujourd'hui</strong><p>Une marque reconnue, des formations, une communauté qui grandit.</p></div></div>
          </div>
